...
namespace Test
{
    ...
    public class TestPolja
    {
        ...
        [TestMethod]
        public void Polje_ZaDvaPoljaKojaImajuIsteKoordinateMentodaEqualsVracaTrue()
        {
        ...
        [TestMethod]
        public void Polje_ZaDvaPoljaKojaNemajuIsteKoordinateMentodaEqualsVracaFalse()
        {
            Polje p1 = new Polje(2, 3);
            Polje p2 = new Polje(2, 2);
